...
class test_main(unittest.TestCase):
    ...
    def test_update_changeless_type(self):
        ...
        self.assertEqual(rv.status_code, 200)
        self.assertRegex(rv.data.decode(), 'https://a/4s5yxhl6exkos')
        self.assertRegex(rv.data.decode(), 'https://a/5LuLnX4l1Ok')

    def test_update_change_type(self):
        rv = self.app.post('/accept/post', data={'uri': 'http://example.com/', 'jamp_flag': 1})
        self.assertEqual(rv.status_code, 200)
        self.assertRegex(rv.data.decode(), 'https://a/hv2zlkml76aj2')
        self.assertRegex(rv.data.decode(), 'https://a/PXWVqYv_gJ0')
    ...
    def test_update2(self):
        ...
        self.assertEqual(rv.status_code, 200)
        self.assertRegex(rv.data.decode(), 'https://a/hjgk26lm7v6qg')
        self.assertRegex(rv.data.decode(), 'https://a/OkyteWz9fQM')
